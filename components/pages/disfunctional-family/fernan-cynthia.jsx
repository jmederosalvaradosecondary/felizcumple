  ...
  return (
    <section className="text-gray-700 body-font">
      <div className="container mx-auto py-6">
        ...
        <div class="mt-6 xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
          <svg
          ...
          <p class="leading-relaxed text-lg">
            A la chinita más linda de mundo mundial! Sabes q te quiero un mundo
            chinita linda! Me encanta como eres, tu forma de pensar, tus
            actitudes. Soy muy feliz de que seamos amigas. Aunq no hablemos casi
            cuando nos encontramos es como si no pasara el tiempo y siento q
            contigo puedo hablar de cualquier cosa! Le doy gracias a las vueltas
            q da la vida por ponerte en mi camino y me arrepiento de no haberte
            conocido antes.. que pases un lindo día rodeado de la gente q te
            quiere y por supuesto ahí estaré yo!!! Felices 22 CORAZÓN Gracias
            por ser TU!
          </p>
        ...
        <div class="mt-6 xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
          ...
          <p class="leading-relaxed text-lg">
            Chinita, Muchas Felicidades. Espero q tengas el día más maravilloso
            del mundo, junto a este grupo d personas q te adoran y q siempre van
            a estar a tu lado, apoyándote en las buenas y en las malas. Te
            quiero mucho!! Un besote
          </p>
          <span class="inline-block h-1 w-10 rounded bg-pink-500 mt-8 mb-6"></span>
          <h2 class="text-gray-900 font-medium title-font tracking-wider text-sm">
            Fernan
